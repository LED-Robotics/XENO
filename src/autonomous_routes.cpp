...
void rightHalfRed()
{
    ...
    chassis.moveToPoint(-33, -38.5, 1000, {.maxSpeed = 100}, false); // move to goal
    chassis.turnToHeading(90, 500);
    bunny_Ear_Piston.set_value(false);
    chassis.moveToPoint(-20, -38.5, 1000, {}, false); // move to goal
}
void leftHalfBlue()
{
    bunny_Ear_Piston.set_value(true);
...
void skills()
{
    ...
    chassis.moveToPoint(-61, -50, 1500, {.maxSpeed = 60}, false); // Drive to matchloader
    preRollers.move(127);
    l2Motor.move(-127);
    delay(200);
    chassis.moveToPoint(-58.5, -49, 200, {.maxSpeed = 100}, false);
    delay(1700);
    ...
    l2Motor.move(-127);
    lw_Piston.set_value(true);
    chassis.moveToPoint(61.5, -50, 2000, {.maxSpeed = 60}, false); // Drive to matchloader
    preRollers.move(127);
    l2Motor.move(-127);
    delay(200);
    ...
    lw_Piston.set_value(true);
    chassis.turnToHeading(90, 500, {.maxSpeed = 100}, false);   // Turn to matchloader
    chassis.moveToPoint(58, 46, 1500, {.maxSpeed = 60}, false); // Drive to matchloader
    preRollers.move(127);
    l2Motor.move(-127);
    delay(200);
    chassis.moveToPoint(57, 46, 300, {.maxSpeed = 100}, false);
    delay(1700);
    preRollers.move(0);
    l2Motor.move(0);
    ...
    chassis.turnToHeading(0, 500);
    chassis.moveToPoint(-50, 48, 1000, {.forwards = false, .maxSpeed = 100}, false); // Drive align with goal
    chassis.turnToHeading(270, 500);
    preRollers.move(127);
    l2Motor.move(-127);
