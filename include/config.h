...
namespace CONFIG
{
    ...
    constexpr QLength TRACK_WIDTH = 11.87_in;
    ...
    inline PID TURN_PID = PID(0.8, 0.0, 6.8);
    ...
    inline Eigen::RowVector2d DRIVETRAIN_LINEAR_VELOCITY_FF{0.546, 0.00272};
    inline Eigen::RowVector2d DRIVETRAIN_ANGULAR_VELOCITY_FF{0.0651, 0.0117};
                                                            ...
                                                            const QAngularAcceleration angularAcceleration)
    {
        const double uLinear =
            DRIVETRAIN_LINEAR_VELOCITY_FF * Eigen::Vector2d(velocity.getValue(), accel.getValue());
        const double uAngular = DRIVETRAIN_ANGULAR_VELOCITY_FF *
